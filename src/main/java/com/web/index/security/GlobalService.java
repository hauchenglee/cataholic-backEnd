...
public class GlobalService {
    ...
    public static final String SYSTEM_NAME = "Cataholic";
    public static final int IMAGE_FILENAME_LENGTH = 20;
    public static final String JNDI_DB_NAME = "java:comp/env/Cataholic/";
...
//	}
    ...
    public static String getSHA1Encoding(String message) {
        final StringBuffer buffer = new StringBuffer();
        try {
     ...
     * @return : 128位元資料的16進位表示法所構成的字串
     */
    public static String getMD5Encoding(File file) throws NoSuchAlgorithmException, IOException {
        MessageDigest md = MessageDigest.getInstance("MD5");
...
//			int value = (b & 0x7F) + (b < 0 ? 128 : 0);
    ...
    public static String getSHA1Encoding(File file) throws NoSuchAlgorithmException, IOException {
...
//			int value = (b & 0x7F) + (b < 0 ? 128 : 0);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //
        String t1 = getSHA1Encoding(file);
